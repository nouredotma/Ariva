              ...
              <AnimatePresence mode="wait">
                ...
                {orderPlaced && (
                  ...
                  >
                    ...
                    <p className="text-base font-bold text-gray-900 font-fauna">Order Placed Successfully!</p>
                  </motion.div>
                )}
                  ...
                  >
                    {items.length === 0 ? (
                      <div className="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p className="text-[11px] text-gray-500 mt-1 max-w-[200px]">Browse our products and add items to your cart.</p>
                      </div>
                    ) : (
