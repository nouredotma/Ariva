            ...
            <div className="space-y-2 mb-4">
              ...
              <label className="flex items-center justify-between p-2.5 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">Help us improve your experience</p>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between p-2.5 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">Used for personalized advertising</p>
                </div>
                <input
                  type="checkbox"
