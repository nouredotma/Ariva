          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 md:gap-8 items-start">
            ...
            <div className="lg:col-span-7 flex flex-col pt-2 lg:pt-0">
              <div className="flex flex-col gap-4 md:gap-5 lg:max-w-3xl">
                ...
                {/* 1. Category Badge */}
                <div className="inline-flex items-center px-4 py-1.5 rounded-full text-[10px] md:text-xs font-bold bg-primary/10 text-primary border border-primary/20 w-fit capitalize">
                  {product.category}
                </div>

                {/* 2. Product Name & Stock */}
                ...
                <div className="border-l-4 border-green-500 bg-green-50 p-2.5 flex items-center gap-2">
                   ...
                   <div className="space-y-0.5">
                      ...
                      <p className="text-[10px] md:text-xs font-medium text-emerald-600">Available throughout Morocco</p>
                   </div>
                </div>
                ...
                <div className="flex flex-row gap-2 pt-2">
                  <button
                    className="flex-2 h-12 md:h-14 rounded-full text-xs md:text-sm font-bold cursor-pointer bg-primary hover:bg-[#9ac58e] text-[#fbfbe5] transition-all flex items-center justify-between px-2 pl-6 md:pl-8 group shadow-sm"
                    onClick={() => {
                      addToCart({
                  ...
                  >
                    <span className="font-fauna tracking-widest text-[11px] md:text-[14px]">Add to Cart</span>
                  ...
                  <Button 
                    className="flex-1 h-12 md:h-14 rounded-full text-xs md:text-sm font-bold bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-sm flex items-center justify-center gap-2 cursor-pointer transition-all active:scale-95 px-6" 
                    asChild
                  >
